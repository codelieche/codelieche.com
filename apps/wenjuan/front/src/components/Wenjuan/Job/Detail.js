...
class JobDetail extends Component {
    ...
    fetchDetailData = () => {
        const url = "http://127.0.0.1:8090/api/v1/wenjuan/job/" + this.state.id;
    ...
    handleAddSubmit = (values) => {
        ...
        // console.log(values);
        // 通过Fetch Post 添加问卷回答
        const url = "http://127.0.0.1:8090/api/v1/wenjuan/report/create";
        fetch(url, {
            method: "POST",
            headers: {
          ...
          .then(response => response.json())
            .then(data => {
                ...
                if( data.id > 0 ){
                    ...
                    this.props.history.push(`/wenjuan/report/${data.id}`);
                }else{
                    message.error(JSON.stringify(data), 5);
                }
            })
    ...
    render() {
        ...
        return (
            <Layout className="wenjuan">
                ...
                <Content>
                    <div className="container wenjuan wenjuan-job">
